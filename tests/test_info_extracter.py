...
def test_extract_info():
    ...
    <html>
        <body>
            <a class="listing listing-card" data-price="200000" data-location="Bogotá" data-rooms="2" data-floorarea="50">
                <p data-test="bathrooms">1 baño</p>
            </a>
            <a class="listing listing-card" data-price="300000" data-location="Bogotá" data-rooms="3" data-floorarea="70">
